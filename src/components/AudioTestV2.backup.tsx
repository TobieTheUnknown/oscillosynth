...
import { LissajousOscilloscope } from './LissajousOscilloscope'
...
export function AudioTestV2() {
  ...
  // Latch mode state (lifted from KeyboardLatchControl)
  const [latchMode, setLatchMode] = useState(false)
  const [activeNotes, setActiveNotes] = useState<Set<number>>(new Set())

  // Get all presets for the selector
  const { getAllPresets, loadPreset } = usePresetStore()
        ...
        <div>
          ...
          <div style={{ maxHeight: 'calc(100vh - 200px)', overflowY: 'auto' }}>
            ...
            {activeTab === 'PLAY' && (
              ...
              >
                {/* Centered: XY Oscilloscope with Integrated Controls */}
                <OscilloscopeXY width={600} height={600}>
                  <IntegratedOscilloscopeControls
                    ...
                    latchMode={latchMode}
                    onLatchToggle={() => setLatchMode(!latchMode)}
            ...
            {activeTab === 'VISUALIZE' && currentPreset && (
              ...
              >
                ...
                <div>
                  ...
                  >
                    LISSAJOUS PATTERNS (LFO PAIR 1)
                  </h3>
                  <LissajousOscilloscope width={550} height={550} />
                </div>
                <div>
                  <h3
                    style={{
